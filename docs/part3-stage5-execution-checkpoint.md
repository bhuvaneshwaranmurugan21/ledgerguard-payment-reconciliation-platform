...
`ab05e7508de1203838c56d959fb5a0eb0ca430f4288e32c12a0116fc9a006f3b`;
...
The first exact-head native run caught that normalizing the inherited Stage 3 wheel
builder changed its frozen runtime. That shared builder was restored: a clean pip
environment again reproduces accepted Stage 3 SHA-256
`12a263615abeeea33a6202ecc49d9fe27606fe1c2b37650f25ba9adebcb7b7f7`,
while normalization is now private to the Stage 5 builder.
